...
| [`settings-card.example.json`](settings-card.example.json) | `settings_card` | Recommended conditions with no test attached: temperature ranges rather than midpoints, reinforcement content. 38 fields populated. |
